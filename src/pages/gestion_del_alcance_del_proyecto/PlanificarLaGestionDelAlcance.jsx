...
const PlanificarLaGestionDelAlcance = () => {
  return (
    <>
    <h1 className='titulo_blog'>1. Planificar la gestión del alcance</h1>
  ...
  <div className="contenedor_informacion_2">
    ...
    <p className="parrafo">
      Es un componente del plan para la direccion del proyecto que describe como
      se analizaran, documentaran y gestionaran los requisitos del proyecto y
      del producto.
    </p>
    <div className="contenedor_pdf">
      <a
...
export default PlanificarLaGestionDelAlcance